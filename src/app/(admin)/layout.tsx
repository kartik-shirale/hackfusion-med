...
export default async function AdminLayout({
    ...
    return (
        <div className="flex h-screen w-full overflow-hidden bg-gradient-to-br from-indigo-50 via-slate-50 to-purple-50">
            ...
            <AdminSidebar />
            <main className="relative flex flex-1 flex-col overflow-y-auto p-3">
                <div className="flex-1 overflow-y-auto rounded-2xl border border-white/40 bg-white/60 shadow-xl backdrop-blur-xl">
                    {children}
                </div>
            </main>
